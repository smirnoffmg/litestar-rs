...
from smallage import Envelope, Record, RedisStreamsTransport
from smallage.core.errors import ConfigurationError
from smallage.core.keys import stream_key
...
WORKER_APP = "tests.litestar._worker_main:app"
...
async def test_the_cli_passes_the_worker_everything_it_takes(
    ...
    from smallage.core.worker import run_with_signals
    from smallage.litestar.cli import worker_arguments
